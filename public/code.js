...
Code.init = function() {
  ...
  Code.bindClick('stopButton', Code.stopPy);
...
Code.runPy = function() {
  ...
  xhr.onreadystatechange = function () {
    if(xhr.readyState === 4 && xhr.status === 200) {
      ...
      if (resObj.hasOwnProperty('errMsg'))
        console.log('Error:\n' + resObj.errMsg);
      else if (resObj.hasOwnProperty('logMsg'))
        console.log('Log:\n' + resObj.logMsg);
      else
        console.log('Unknown response ' + xhr.response);
    }
